...
void Rotate2DArray_odd_Rows(int DataFirst[MaxRowSize][MaxColSize], int DataFinal[MaxRowSize][MaxColSize], int i, int j, int RSize, int CSize);
...
int main(void){
	...
	Rotate2DArray_odd_Rows(DataFirst, DataFinal, i, j, RSize, CSize);
