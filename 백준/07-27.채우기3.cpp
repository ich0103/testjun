// ================================================================================================
// 채우기 3. 좌하우상 대각선을 기준으로 위쪽을 0으로 채워넣기
// ================================================================================================
/*
==============================
변경 전
...
void Nested2DArrayLeftUpZero(int DataFirst[MaxRowSize][MaxColSize], int DataFinal[MaxRowSize][MaxColSize], int i, int j, int RSize, int CSize);
void Nested2DArrayLeftUpZero(int DataFirst[MaxRowSize][MaxColSize], int DataFinal[MaxRowSize][MaxColSize], int i, int j, int RSize, int CSize);
...
int main(void){
	...
	Nested2DArrayLeftUpZero(DataFirst, DataFinal, i, j, RSize, CSize);
