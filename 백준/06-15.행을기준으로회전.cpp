...
void Rotate2DArray_Row(int DataFirst[MaxRowSize][MaxColSize], int DataFinal[MaxRowSize][MaxColSize], int i, int j, int RSize, int CSize);
int main(void){
	...
	Rotate2DArray_Row(DataFirst, DataFinal, i, j, RSize, CSize);
