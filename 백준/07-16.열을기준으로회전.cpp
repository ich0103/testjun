...
//void Rotate2DArray_Col(int DataFirst[MaxRowSize][MaxColSize], int DataFinal[MaxRowSize][MaxColSize], int i, int j, int RSize, int CSize);
//
//int main(void){
...
//
//	Rotate2DArray_Col(DataFirst, DataFinal, i, j, RSize, CSize);
//
...
//		for (j = 0; j < CSize; j++)
//		{
//			DataFinal[i][j] = DataFirst[RSize-i-1][j];
//		}
//	}
//}
//#endif