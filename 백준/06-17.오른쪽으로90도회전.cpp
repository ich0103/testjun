...
변경 후
==============================
26 21 16 11  6  1  0  0  0  0
27 22 17 12  7  2  0  0  0  0
28 23 18 13  8  3  0  0  0  0
29 24 19 14  9  4  0  0  0  0
...
void Rotate2DArray_right_90(int DataFirst[MaxRowSize][MaxColSize], int DataFinal[MaxRowSize][MaxColSize], int i, int j, int RSize, int CSize);

int main(void){
	int DataFirst[MaxRowSize][MaxColSize];
	int DataFinal[MaxRowSize][MaxColSize];
	int DataTemp[MaxRowSize][MaxColSize];
	int i, j, RSize, CSize;
	...
	Rotate2DArray_right_90(DataFirst, DataFinal, i, j, RSize, CSize);
...
void Rotate2DArray_right_90(int DataFirst[MaxRowSize][MaxColSize], int DataFinal[MaxRowSize][MaxColSize], int i, int j, int RSize, int CSize)
{
	for (i = 0; i < RSize + (CSize - RSize); i++)
	{
		...
		{
			DataFinal[i][j] = DataFirst[(CSize + (RSize - CSize) - 1) - j][i];
		}
	}
}
#endif